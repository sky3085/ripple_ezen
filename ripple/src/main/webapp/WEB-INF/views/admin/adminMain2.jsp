...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">Ripple</a>
...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../admin/adminMain.jsp?req=adminMember">
              <span data-feather="file" class="align-text-bottom"></span>
              회원 관리
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../admin/adminMain.jsp?req=adminReply">
        ...
        <ul class="nav flex-column mb-2">
          <li class="nav-item">
            <a class="nav-link" href="../admin/adminMain.jsp?req=adminRank">
              <span data-feather="file-text" class="align-text-bottom"></span>
              rank
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../admin/adminMain.jsp?req=adminMovie">
              <span data-feather="file-text" class="align-text-bottom"></span>
              movie theather
            </a>
          </li>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="my-4 w-100" id="myChart" width="900" height="500">
  ...
  <footer class="container">
    ...
    <p>&copy; 2022 이젠아카데미 3팀 &middot; <a href="#">이젠아카데미</a> &middot; <a href="#">기타</a></p>
