    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <header class="masthead text-center text-white" style="height: 100vh"> 
            <div class="masthead-content">
                <div class="container px-5">
                    <h2 class="masthead-heading mb-0">리플</h2><br><br>
            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6 order-lg-2">
                        <div class="p-5"><img class="img-fluid rounded-circle" src="resources/img/ai.png" alt="..." /></div>
                    </div>
        ...
        <section>
            <div class="container px-5">
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        <div class="p-5"><img class="img-fluid rounded-circle" src="resources/img/movies2.png" alt="..." /></div>
                    </div>
                    <div class="col-lg-6">
                        <div class="p-5">
        ...
        <section>
            <div class="container px-5">
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6 order-lg-2">
                        <div class="p-5"><img class="img-fluid rounded-circle" src="resources/img/map.png" alt="..." /></div>
                    </div>
                    <div class="col-lg-6 order-lg-1">
                        <div class="p-5">
        ...
        <footer class="py-5 bg-black">
            <div class="container px-5"><p class="m-0 text-center text-white small">EZEN IT ACADEMY - 3 TEAM</p></div>
        </footer>
